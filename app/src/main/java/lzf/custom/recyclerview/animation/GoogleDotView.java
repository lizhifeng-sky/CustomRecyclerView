package lzf.custom.recyclerview.animation;
...
public class GoogleDotView extends View implements IHeadView {
    private Paint mPath;
    private float r;
    private int num = 5;
